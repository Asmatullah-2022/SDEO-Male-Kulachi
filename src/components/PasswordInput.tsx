...
/**
 * Same look as Input, plus an eye-icon toggle to reveal/hide the typed
 * password. Kept as its own component (rather than adding a "toggle"
 * prop to Input) so every other password field in the app — Login,
 * Change Password — is completely unaffected by this addition.
 */
    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <input
          ...
          className={[
            "w-full rounded-xl border-2 px-4 py-3.5 pr-12 text-base text-brand-900",
