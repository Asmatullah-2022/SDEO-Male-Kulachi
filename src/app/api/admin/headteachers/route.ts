...
export async function POST(request: NextRequest) {
  ...
  if (createError || !created.user) {
    ...
    if (!isDuplicate) {
      logSupabaseError("POST /api/admin/headteachers:auth.admin.createUser", createError);
    }
  ...
  if (profileError) {
    logSupabaseError("POST /api/admin/headteachers:profiles.update", profileError);
